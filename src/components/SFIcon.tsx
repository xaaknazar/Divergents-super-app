...
export type SFName =
  ...
  | 'cart.fill' | 'cart' | 'target' | 'location.fill' | 'bolt.fill' | 'clock' | 'clock.arrow.circlepath' | 'lock.open.fill' | 'photo' | 'smallcircle.filled.circle' | 'xmark.circle.fill' | 'waveform' | 'doc.text.fill' | 'headphones' | 'eye.fill' | 'person.2.fill' | 'figure.run' | 'brain.head.profile'
...
const MAP: Record<string, [Lib, string]> = {
  ...
  'clock': ['ion', 'time-outline'], 'clock.arrow.circlepath': ['ion', 'time-outline'], 'lock.open.fill': ['ion', 'lock-open'], 'photo': ['ion', 'image'], 'smallcircle.filled.circle': ['ion', 'ellipse'], 'xmark.circle.fill': ['ion', 'close-circle'],
 'bolt.fill': ['ion', 'flash'],
