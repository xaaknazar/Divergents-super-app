...
export type SFName =
  ...
  | 'cart.fill' | 'cart' | 'target' | 'location.fill' | 'bolt.fill' | 'clock.arrow.circlepath' | 'lock.open.fill' | 'photo' | 'smallcircle.filled.circle' | 'xmark.circle.fill' | 'figure.run' | 'brain.head.profile'
