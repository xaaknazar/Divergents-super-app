...
export const RESUME_STEPS: ResumeStep[] = [
  {
    ...
    fields: [
      { key: 'nickname', label: 'Псевдоним', type: 'text', placeholder: 'Например: Aknazar' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'expected_salary', label: 'Ожидания по зарплате', type: 'text', placeholder: 'напр. от 500 000 ₸' },
